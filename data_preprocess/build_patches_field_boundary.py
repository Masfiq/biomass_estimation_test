# Building 3x3 patches for HLS (8 bands) + NLCD (1 band) = 9 bands total. Field boundary region.
# Same logic as build_patches_version_3.py:
...
# (3) Bounds pre-cached during HLS indexing — zero file I/O in per-shot granule lookup
...
PATCHES_ROOT = "/s/chopin/e/proj/hyperspec/masfiq/dataset/patch_tifs_field_boundary_2021_AprilToAugust_version_3"

OUT_CSV_PATH = "/s/chopin/e/proj/hyperspec/masfiq/csv_files/gedi_field_boundary_2021_AprilToAugust_version_3.csv"
