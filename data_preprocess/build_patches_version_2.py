# buiding 3 x 3 patches for hcl(8 bands),  NLCD(1 band ), sentinel 1 bands(2 bands) and stack them for the input for CNN model 
...
S1_ROOT = r"/s/chopin/e/proj/hyperspec/masfiq/dataset/sentinel_1_data/sentinel_1_data_california_north_10_2021_April_toAugust"
...
PATCHES_ROOT = "/s/chopin/e/proj/hyperspec/masfiq/dataset/patch_tifs_california_north_10_2021_AprilToAugust_with_s1"
...
OUT_CSV_PATH = "/s/chopin/e/proj/hyperspec/masfiq/csv_files/gedi_california_north_10_2021_whole_year_metadata_with_s1.csv"
...
MAX_WORKERS = 1 # means we are using 18 workers , in the slurm scrpt we set cpus-per-task=20, so the 18 workers will use the 20 cpus 
...
def find_s1_scene_for_point(lon, lat, s1_index):
    """
    Finds a Sentinel-1 scene that spatially covers the GEDI/HLS point.
    ...
    for scene in s1_index:
        ...
        # Reproject GEDI lon/lat into Sentinel-1 CRS
