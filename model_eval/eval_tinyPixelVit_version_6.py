# eval for tinyPixelViT_version_6 — 5x5 patches, version_6 CSV, Huber-trained
...
# version_6's training run saved a "_best" checkpoint (epoch 100, Val Huber 0.2584) —
# here the final epoch happened to be the best one (no meaningful overfitting), but
# this eval defaults to the _best checkpoint anyway for consistency with the other two.
...
def main():
    ...
    ap.add_argument("--ckpt", default="/s/chopin/e/proj/hyperspec/masfiq/models/tinyPixelViT_version_6_fusion_geohash_month_koppen_SAR_version_6_California_North_10_2021_best.pth")
    ap.add_argument("--val-frac", type=float, default=0.2)
    ap.add_argument("--seed", type=int, default=42)
    ap.add_argument("--batch-size", type=int, default=256)
    ap.add_argument("--geohash-precision", type=int, default=7)
    ap.add_argument("--out", default="tinyPixelViT_version_6_eval_version_6.json")
