...
#SBATCH --output=out_and_err/eval_resnet18_version_5(2)_%j.out
#SBATCH --error=out_and_err/eval_resnet18_version_5(2)_%j.err


############################ edit variable here
PYTHON_FILE="eval_resnet18_version_5(2).py"

CSV_PATH="/s/chopin/e/proj/hyperspec/masfiq/csv_files/gedi_California_california_north_10_2021_whole_year_metadata.csv"

CKPT_PATH="/s/chopin/e/proj/hyperspec/masfiq/models/resnet18_version_5_fusion_geohash_month_koppen_withAttentionLayer_California_North_10_2021.pth"
...
OUT_PATH="/s/chopin/e/proj/hyperspec/masfiq/models/json/resnet18_version_5_fusion_geohash_month_koppen_withAttentionLayer_California_North_10_2021.json"
