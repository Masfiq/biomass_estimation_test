# eval for tinyUnet_version_6 — 5x5 patches, version_6 CSV, Huber-trained
...
def main():
    ...
    ap.add_argument("--ckpt", default="/s/chopin/e/proj/hyperspec/masfiq/models/tinyUnet_version_6_fusion_geohash_month_koppen_withAttentionLayer_SAR_version_6_California_North_10_2021.pth")
    ap.add_argument("--val-frac", type=float, default=0.2)
    ap.add_argument("--seed", type=int, default=42)
    ap.add_argument("--batch-size", type=int, default=256)
    ap.add_argument("--geohash-precision", type=int, default=7)
    ap.add_argument("--out", default="tinyUnet_version_6_eval_version_6.json")
