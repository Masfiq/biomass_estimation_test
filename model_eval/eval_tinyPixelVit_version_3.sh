#!/bin/bash
#SBATCH --job-name=eval_tinypixelvit_v3
...
#SBATCH --output=out_and_err/eval_tinyPixelVit_version_3_%j.out
#SBATCH --error=out_and_err/eval_tinyPixelVit_version_3_%j.err


####################################################### edit these
PYTHON_FILE="eval_tinyPixelVit_version_3.py"

CSV_PATH="/s/chopin/e/proj/hyperspec/masfiq/csv_files/gedi_california_north_10_2021_AprilToAugust_version_5.csv"

CKPT_PATH="/s/chopin/e/proj/hyperspec/masfiq/models/tinyPixelViT_version_3_fusion_geohash_month_koppen_version_5_California_North_10_2021.pth"

VAL_FRAC=0.2
SEED=42
BATCH_SIZE=256

OUT_PATH="/s/chopin/e/proj/hyperspec/masfiq/models/json/tinyPixelViT_version_3_eval_version_5.json"
