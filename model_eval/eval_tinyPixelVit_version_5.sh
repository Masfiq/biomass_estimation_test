#!/bin/bash
#SBATCH --job-name=eval_tinyPixelViT_v5
...
#SBATCH --output=out_and_err/eval_tinyPixelVit_version_5_%j.out
#SBATCH --error=out_and_err/eval_tinyPixelVit_version_5_%j.err


############################ edit variable here
PYTHON_FILE="eval_tinyPixelVit_version_5.py"

CSV_PATH="/s/chopin/e/proj/hyperspec/masfiq/csv_files/gedi_california_north_10_2021_AprilToAugust_version_6.csv"

CKPT_PATH="/s/chopin/e/proj/hyperspec/masfiq/models/tinyPixelViT_version_5_fusion_geohash_month_koppen_SAR_version_6_California_North_10_2021.pth"

VAL_FRAC=0.2
SEED=42
BATCH_SIZE=256

OUT_PATH="/s/chopin/e/proj/hyperspec/masfiq/models/json/tinyPixelViT_version_5_eval_version_6.json"
