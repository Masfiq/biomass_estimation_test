...
class GEDIHlsPatchDatasetFusion(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # Now convert image to torch tensor AFTER Sentinel-1 is added
        ...
        # ----------------------------
        # Auxiliary vector
        # month sin/cos + koppen one-hot + gridMET
        # ----------------------------
...
def main():
    ...
    ap.add_argument("--ckpt", default="/s/chopin/e/proj/hyperspec/masfiq/models/resnet101_fusion_geohash_month_koppen_withAttentionLayer_field_boundary_version_3.pth")
    ap.add_argument("--val-frac", type=float, default=0.2)
    ap.add_argument("--seed", type=int, default=42)
    ap.add_argument("--batch-size", type=int, default=256)
    ap.add_argument("--geohash-precision", type=int, default=7)
    ap.add_argument("--out", default="resnet101_eval_field_boundary.json")
    args = ap.parse_args()
