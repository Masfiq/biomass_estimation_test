...
#SBATCH --output=out_and_err/eval_tinyUnet_version_1_%j.out
#SBATCH --error=out_and_err/eval_tinyUnet_version_1_%j.err


###################################################### edit these 

PYTHON_FILE="eval_tinyUnet_version_1.py"

CSV_PATH="/s/chopin/e/proj/hyperspec/masfiq/csv_files/gedi_California_california_north_10_2021_whole_year_metadata.csv"

CKPT_PATH="/s/chopin/e/proj/hyperspec/masfiq/models/tinyUnet_fusion_geohash_month_koppen_California_North_10_2021.pth"
...
OUT_PATH="/s/chopin/e/proj/hyperspec/masfiq/models/json/tinyUnet_eval_California_North_10_2021.json"
