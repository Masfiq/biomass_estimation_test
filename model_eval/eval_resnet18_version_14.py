# eval for resnet18_version_14 — 5x5 patches, version_6 CSV, Huber-trained
...
# version_14's training run saved a "_best" checkpoint (epoch 084, Val Huber 0.3154)
# separately from the final-epoch one (epoch 100, Val Huber 0.3223, more overfit), so
# this eval defaults to the _best checkpoint rather than the plain OUTPUT_PATH one.
...
def main():
    ...
    ap.add_argument("--ckpt", default="/s/chopin/e/proj/hyperspec/masfiq/models/resnet18_version_14_fusion_geohash_month_koppen_withAttentionLayer_SAR_version_6_California_North_10_2021_best.pth")
    ap.add_argument("--val-frac", type=float, default=0.2)
    ap.add_argument("--seed", type=int, default=42)
    ap.add_argument("--batch-size", type=int, default=256)
    ap.add_argument("--geohash-precision", type=int, default=7)
    ap.add_argument("--out", default="resnet18_version_14_eval_version_6.json")
    args = ap.parse_args()
