# eval for tinyUnet_version_7 — 5x5 patches, version_6 CSV, Huber-trained
...
# version_7's training run saved a "_best" checkpoint (epoch 027, Val Huber 0.2698)
# separately from the final-epoch one (epoch 100, Val Huber 0.2898, more overfit), so
