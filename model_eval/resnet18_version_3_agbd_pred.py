...
if __name__ == "__main__":
    # ======= EDIT THESE =======
    csv_path = "/s/chopin/e/proj/hyperspec/masfiq/dataset/csv_files/gedi_California_North_12_metadata.csv"
    checkpoint_path = "/s/chopin/e/proj/hyperspec/masfiq/models/resnet18_fusion_geohash_month_koppen_California_North_12.pth"
    ...
    out_csv = "/s/chopin/e/proj/hyperspec/masfiq/dataset/csv_files/gedi_with_predictions_fusion_California_North_12.csv"
    # ===========================
    ...
    dataset = GEDIHlsPatchDatasetFusion(
        ...
        koppen_legend_path=legend_path,
    )
