...
#SBATCH --output=out_and_err/eval_resnet18_version_9_%j.out
#SBATCH --error=out_and_err/eval_resnet18_version_9_%j.err


############################ edit variable here
PYTHON_FILE="eval_resnet18_version_9.py"

CSV_PATH="/s/chopin/e/proj/hyperspec/masfiq/csv_files/gedi_california_north_10_2021_AprilToAugust_version_3.csv"

CKPT_PATH="/s/chopin/e/proj/hyperspec/masfiq/models/resnet18_version_9_fusion_geohash_month_koppen_withAttentionLayer_version_3_California_North_10_2021.pth"

VAL_FRAC=0.2
SEED=42
BATCH_SIZE=256

OUT_PATH="/s/chopin/e/proj/hyperspec/masfiq/models/json/resnet18_version_9_eval_version_3.json"
