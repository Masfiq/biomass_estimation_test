...
#SBATCH --output=out_and_err/eval_resnet18_version_8_%j.out
#SBATCH --error=out_and_err/eval_resnet18_version_8_%j.err


############################ edit variable here
PYTHON_FILE="eval_resnet18_version_8.py"

CSV_PATH="/s/chopin/e/proj/hyperspec/masfiq/csv_files/gedi_California_california_north_10_2021_whole_year_metadata.csv"

CKPT_PATH="/s/chopin/e/proj/hyperspec/masfiq/models/resnet18_version_8_fusion_geohash_month_koppen_withAttentionLayer_SAR1_California_North_10_2021.pth"
...
OUT_PATH="/s/chopin/e/proj/hyperspec/masfiq/models/json/resnet18_version_8_fusion_geohash_month_koppen_withAttentionLayer_SAR1_California_North_10_2021.json"
