# tiny Unet version 2 with attention layer

# path variables are in the bash file .sh
...
class GEDIHlsPatchDatasetFusion(Dataset):
    ...
    def _load_patch_fixed_channels(self, patch_path: Path, bands_str: str | None):
        ...
        # Scale reflectance-like bands only. Do not scale NLCD.
...
def main():
    ...
    ap.add_argument("--ckpt", default="/s/chopin/e/proj/hyperspec/masfiq/models/tinyUnet_fusion_geohash_month_koppen_withAttentionLayer_field_boundary_version_3.pth")
    ap.add_argument("--val-frac", type=float, default=0.2)
    ap.add_argument("--seed", type=int, default=42)
    ap.add_argument("--batch-size", type=int, default=256)
    ap.add_argument("--geohash-precision", type=int, default=7)
    ap.add_argument("--out", default="tinyUnet_eval_field_boundary.json")
