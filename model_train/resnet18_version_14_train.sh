#!/bin/bash
#SBATCH --job-name=biomass_attn_v14
...
#SBATCH --output=out_and_err/resnet18_version_14_%j.out
#SBATCH --error=out_and_err/resnet18_version_14_%j.err
...
nvidia-smi
srun python -u resnet18_version_14_train.py
