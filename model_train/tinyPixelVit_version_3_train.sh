...
#SBATCH --output=out_and_err/tinyPixelVit_version_3_train_%j.out
#SBATCH --error=out_and_err/tinyPixelVit_version_3_train_%j.err
...
nvidia-smi
srun python -u tinyPixelVit_version_3_train.py
