# resnet18 version 12
# version 11 + SAR (Sentinel-1 VV/VH)
...
OUTPUT_PATH = Path("/s/chopin/e/proj/hyperspec/masfiq/models/resnet18_version_12_fusion_geohash_month_koppen_withAttentionLayer_SAR_version_5_California_North_10_2021.pth")
    ...
    def __getitem__(self, idx):
        ...
        if self.sentinel1_lookup is not None:
            try:
                ...
                # print("[S1 DEBUG __getitem__] S1_VV center:", x_img_np[vv_idx, 2, 2], flush=True)
                # print("[S1 DEBUG __getitem__] S1_VH center:", x_img_np[vh_idx, 2, 2], flush=True)
