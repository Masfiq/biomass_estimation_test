...
#SBATCH --output=out_and_err/tinyUnet_version_4_train_%j.out
#SBATCH --error=out_and_err/tinyUnet_version_4_train_%j.err
...
nvidia-smi
srun python -u tinyUnet_version_4_train.py
