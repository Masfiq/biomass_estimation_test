#!/bin/bash
#SBATCH --job-name=biomass_attn_pvit_v6
...
#SBATCH --output=out_and_err/tinyPixelVit_version_6_train_%j.out
#SBATCH --error=out_and_err/tinyPixelVit_version_6_train_%j.err
...
nvidia-smi
srun python -u tinyPixelVit_version_6_train.py
