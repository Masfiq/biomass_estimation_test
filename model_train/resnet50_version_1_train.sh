...
#SBATCH --output=out_and_err/resnet50_version_1_%j.out
#SBATCH --error=out_and_err/resnet50_version_1_%j.err
...
nvidia-smi
srun --cpus-per-task=8 python -u resnet50_version_1_train.py