# we are using tuny Unet model instead of rsnet18 model without the attention layer
...
OUTPUT_PATH = Path("/s/chopin/e/proj/hyperspec/masfiq/models/tinyUnet_fusion_geohash_month_koppen_California_North_10_2021.pth")
...
def create_dataloaders(csv_path, batch_size=32, val_frac=0.2, geohash_precision=7):
    ...
    # Peek 
    print("Length of the dataframe :", len(ds))
    x_img, gh_idx, x_aux, y = ds[10000]
