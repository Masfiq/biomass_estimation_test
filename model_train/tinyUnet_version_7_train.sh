#!/bin/bash
#SBATCH --job-name=biomass_attn_unet_v7
...
#SBATCH --output=out_and_err/tinyUnet_version_7_train_%j.out
#SBATCH --error=out_and_err/tinyUnet_version_7_train_%j.err
...
nvidia-smi
srun python -u tinyUnet_version_7_train.py
