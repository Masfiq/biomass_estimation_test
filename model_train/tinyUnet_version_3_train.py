# we are using tuny Unet model with attention layer here in version 2 instead of just Tiny Unet without the attention layer
...
#OUTPUT_PATH = Path("/s/chopin/e/proj/hyperspec/masfiq/models/tinyUnet_fusion_geohash_month_koppen_withAttentionLayer_California_North_10_2021.pth")
OUTPUT_PATH = Path("/s/chopin/e/proj/hyperspec/masfiq/models/tinyUnet_version_3_fusion_geohash_month_koppen_withAttentionLayer_version_5_California_North_10_2021.pth")
