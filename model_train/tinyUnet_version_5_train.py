# tinyUnet version 5
# version 4 + SAR (Sentinel-1 VV/VH)
...
OUTPUT_PATH = Path("/s/chopin/e/proj/hyperspec/masfiq/models/tinyUnet_version_5_fusion_geohash_month_koppen_withAttentionLayer_SAR_version_5_California_North_10_2021.pth")
