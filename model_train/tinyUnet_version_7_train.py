# tinyUnet version 7
# version 6 + best-validation checkpointing. version_6's run showed validation Huber
# bottoming out at epoch 56 (0.2614) then drifting to 0.2701 by epoch 100, but the
...
OUTPUT_PATH = Path("/s/chopin/e/proj/hyperspec/masfiq/models/tinyUnet_version_7_fusion_geohash_month_koppen_withAttentionLayer_SAR_version_6_California_North_10_2021.pth")
