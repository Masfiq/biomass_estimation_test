#!/bin/bash
#SBATCH --job-name=biomass_attn_v13
...
#SBATCH --output=out_and_err/resnet18_version_13_%j.out
#SBATCH --error=out_and_err/resnet18_version_13_%j.err
...
nvidia-smi
srun python -u resnet18_version_13_train.py
