#!/bin/bash
#SBATCH --job-name=biomass_attn_pvit_v4
...
#SBATCH --output=out_and_err/tinyPixelVit_version_4_train_%j.out
#SBATCH --error=out_and_err/tinyPixelVit_version_4_train_%j.err
...
nvidia-smi
srun python -u tinyPixelVit_version_4_train.py
