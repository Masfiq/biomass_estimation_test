#!/bin/bash
#SBATCH --job-name=biomass_attn_v15
...
#SBATCH --output=out_and_err/resnet18_version_15_%j.out
#SBATCH --error=out_and_err/resnet18_version_15_%j.err
...
# workers blows past the cgroup limit and gets OOM-killed. Version_15 adds the
...
nvidia-smi
srun python -u resnet18_version_15_train.py
