# resnet18 version 13
# version 12 + patches built from build_patches_version_6 (SAR now baked directly into
# the patch tif, correctly georeferenced via GCPs and matched within 3 days, instead of
# being fetched live at train time from the old 26-file archive). The separate
# Sentinel1Lookup class and SENTINEL1_DIR mechanism are removed: S1_VV/S1_VH now arrive
# through the same "bands" CSV column mapping already used for every other band.
...
OUTPUT_PATH = Path("/s/chopin/e/proj/hyperspec/masfiq/models/resnet18_version_13_fusion_geohash_month_koppen_withAttentionLayer_SAR_version_6_California_North_10_2021.pth")
