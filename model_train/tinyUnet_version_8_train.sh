#!/bin/bash
#SBATCH --job-name=biomass_attn_unet_v8
...
#SBATCH --output=out_and_err/tinyUnet_version_8_train_%j.out
#SBATCH --error=out_and_err/tinyUnet_version_8_train_%j.err
...
# workers blows past the cgroup limit and gets OOM-killed. Version_8 adds the
...
nvidia-smi
srun python -u tinyUnet_version_8_train.py
