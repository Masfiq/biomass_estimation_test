...
################################## CHANGE VALUE HERE 
CSV_PATH = "/s/chopin/e/proj/hyperspec/masfiq/csv_files/gedi_field_boundary_2021_AprilToAugust_version_3.csv"
...
OUTPUT_PATH = Path("/s/chopin/e/proj/hyperspec/masfiq/models/resnet101_fusion_geohash_month_koppen_withAttentionLayer_field_boundary_version_3.pth")
...
SENTINEL1_DIR = None  # No Sentinel-1 data for field boundary


fixed_bands = [
    "B02","B03","B04","B05","B06","B07","B8A","B11","B12","EVI","NDVI","NLCD",
    "S1_VV","S1_VH"
]
...
# ----------------------------
class ResNet101FusionRegressorAttn(nn.Module):
    def __init__(
        self,
        in_channels: int,
        ...
        self.fusion_gate = FusionGate(img_dim=2048, gh_dim=geohash_emb_dim, aux_dim=aux_dim, hidden=128)

        fused_dim = 2048 + geohash_emb_dim + aux_dim
...
def train_model(
    ...
    model = ResNet101FusionRegressorAttn(
