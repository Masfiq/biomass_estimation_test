# this version is resnet18 model trained with the following bands
...
# also I am using seed 42 which means which remains same for the validation

# we are not using amp(automatic mixed precision) for this 

# here we add the attention layer(Channnel , spatial and fusion) to the existing model pipeline in resnet 18 version 3
...
OUTPUT_PATH = Path("/s/chopin/e/proj/hyperspec/masfiq/models/resnet18_version_5_fusion_geohash_month_koppen_withAttentionLayer_California_North_10_2021.pth")
