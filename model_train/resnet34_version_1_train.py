...
OUTPUT_PATH = Path("/s/chopin/e/proj/hyperspec/masfiq/models/resnet34_version_1_fusion_geohash_month_koppen_withAttentionLayer_SAR1_California_North_10_2021.pth")
...
# ----------------------------
class ResNet34FusionRegressorAttn(nn.Module):
    def __init__(
        self,
        in_channels: int,
...
def train_model(
    ...
    model = ResNet34FusionRegressorAttn(
