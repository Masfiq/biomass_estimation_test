# tinyUnet version 8
# version 7 + two changes: (A) Copernicus DEM terrain aux features, (B) sqrt target
# instead of log1p. Best-validation checkpointing from version_7 is kept unchanged.
#
...
OUTPUT_PATH = Path("/s/chopin/e/proj/hyperspec/masfiq/models/tinyUnet_version_8_fusion_geohash_month_koppen_withAttentionLayer_SAR_DEM_sqrt_version_6_California_North_10_2021.pth")
